...
function voiceToneFor(input) {
  if (input.adAutomation.moodPreset === "bold") return "첫 문장은 선명하게, 본문은 사실 근거와 사용 맥락으로 받쳐주는 톤입니다.";
  if (input.adAutomation.moodPreset === "editorial") return "소재와 장면을 설명하는 편집형 문장으로 신뢰를 쌓는 톤입니다.";
  return "정돈된 정보 전달과 안전한 표현을 우선하는 차분한 톤입니다.";
}
