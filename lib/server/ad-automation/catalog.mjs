...
export const AD_MOOD_PRESETS = {
  ...
  premium: { id: "premium", label: "Premium", description: "완성도, 출처, 신뢰 단서를 차분하게 강조하는 고급형 흐름" },
  warm: { id: "warm", label: "Warm", description: "일상 장면과 사용 감정을 부드럽게 연결하는 생활형 흐름" },
  fresh: { id: "fresh", label: "Fresh", description: "과일·채소의 수확감, 산지, 신선도, 보관 포인트를 식탁 장면과 연결" },
  minimal: { id: "minimal", label: "Minimal", description: "문장과 장식을 절제하고 핵심 정보 위계를 또렷하게 유지" },
  energetic: { id: "energetic", label: "Energetic", description: "프로모션, 혜택, 빠른 행동 유도를 활기 있게 구성" },
  technical: { id: "technical", label: "Technical", description: "스펙, 검증 포인트, 선택 기준을 구조적으로 설명" },
  gift: { id: "gift", label: "Gift", description: "선물 맥락, 구성 가치, 받는 사람의 사용 장면을 강조" },
  seasonal: { id: "seasonal", label: "Seasonal", description: "시즌, 이벤트, 상황 전환에 맞춘 구매 이유를 제안" },
};

const MOOD_ANGLE_BOOSTS = {
  bold: ["problem-solution", "before-after", "comparison", "speed-convenience", "objection-handling"],
  editorial: ["lifestyle-scene", "ingredient-material", "premium-origin", "seasonal-context", "how-to-use"],
  clean: ["benefit-stack", "expert-rationale", "risk-reversal", "offer-value", "comparison"],
  premium: ["premium-origin", "expert-rationale", "ingredient-material", "risk-reversal", "offer-value"],
  warm: ["lifestyle-scene", "how-to-use", "social-proof", "seasonal-context", "problem-solution"],
  fresh: ["ingredient-material", "seasonal-context", "lifestyle-scene", "risk-reversal", "how-to-use"],
  minimal: ["benefit-stack", "comparison", "expert-rationale", "speed-convenience", "risk-reversal"],
  energetic: ["speed-convenience", "offer-value", "before-after", "problem-solution", "objection-handling"],
  technical: ["expert-rationale", "ingredient-material", "comparison", "benefit-stack", "risk-reversal"],
  gift: ["seasonal-context", "offer-value", "lifestyle-scene", "premium-origin", "risk-reversal"],
  seasonal: ["seasonal-context", "lifestyle-scene", "offer-value", "how-to-use", "social-proof"],
};
...
export const COPY_ANGLE_CATALOG = [
  ...
  { id: "ingredient-material", label: "성분/소재", description: "성분, 소재, 마감처럼 확인 가능한 구성 요소 중심", keywords: ["원목", "성분", "소재", "마감", "촉감", "재질", "산지", "수확", "신선", "당도", "식감", "품종"] },
  { id: "lifestyle-scene", label: "라이프스타일 장면", description: "실제 생활/업무 맥락에서 쓰는 모습을 먼저 보여주는 구조", keywords: ["사용", "장면", "사무실", "재택", "책상", "휴대", "라이프", "식탁", "샐러드", "간식", "요리"] },
  { id: "speed-convenience", label: "속도/편의", description: "설치, 시작, 이해가 빠른 경험을 강조", keywords: ["간편", "빠른", "설치", "바로", "쉬움", "편리"] },
  { id: "risk-reversal", label: "위험 완화", description: "보증, 안전, 선택 실패 부담을 낮추는 정보 구조", keywords: ["보증", "안전", "교환", "환불", "정품", "안심", "신선도", "배송", "보관"] },
  ...
  { id: "how-to-use", label: "사용 방법", description: "설치·사용 순서와 루틴 정착을 안내", keywords: ["방법", "사용법", "매일", "루틴", "반복", "습관", "보관", "세척", "손질"] },
  { id: "seasonal-context", label: "시즌/상황", description: "선물, 새 학기, 업무 환경 전환 같은 시점 맥락", keywords: ["선물", "시즌", "새학기", "입사", "이사", "연말", "제철", "수확", "명절"] },
...
function scoreAngle(scoreInput) {
  ...
  if (MOOD_ANGLE_BOOSTS[context.moodPreset]?.includes(angle.id)) score += 5;
